...
public class Main {
	...
	private static void aprenderPolimorfismo() {
		...
		sergioMichael.comemorarVitoria(); // procura primeiro na minha classe Nadador, como o método com polimorfismo
											// não foi acionado com o envio de uma frase, usara o metodo da herança.
		michaelPhelps.comemorarVitoria(); // procura primeiro na minha classe Nadador, como o método com polimorfismo
											// não foi acionado com o envio de uma frase, usara o metodo da herança.

		sergioMichael.comemorarVitoria(" Foi árduo, mas consegui!"); // Enviando uma frase, acessar o metodo com
